module Periodic
  ...
  # stranded agent webhook and stuck GitHub/Fizzy-claim recovery, the
  # expired presence-lease sweep, the one-time plaintext bot-token
  # clearing, and the daily retention prune all live
